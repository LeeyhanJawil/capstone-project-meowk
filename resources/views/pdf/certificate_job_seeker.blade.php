    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="footer-sider">
                Amount Paid: {{$certificate_job_seekers->amount_paid}}
                <br>
                Cert. No./O.R. No: {{$certificate_job_seekers->or_number}}
                <br>
                Date Paid:  {{$certificate_job_seekers->date}}
            </div>
        ...
        <div class="main">
            ...
            <p class="main-para">
                Signed this {{$certificate_job_seekers->date}} at {{$certificate_job_seekers->full_address}}.
            </p>
            <p class="validity">

...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul>
                <li class="li-margin">
                    <h5 style="font-size: 17px;">Hon. {{ $certificate_residencies->punongbarangay }}</h5>
            ...
            <div class="footer-sider">
                Amount Paid: {{$certificate_residencies->amount_paid}}
                <br>
                Cert. No./O.R. No: {{$certificate_residencies->or_number}}
                <br>
                Date Paid:  {{$certificate_residencies->date}}
            </div>

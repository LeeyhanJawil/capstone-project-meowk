    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="footer-sider">
                Amount Paid: {{$certificate_unemployments->amount_paid}}
                <br>
                Cert. No./O.R. No: {{$certificate_unemployments->or_number}}
                <br>
                Date Paid:  {{$certificate_unemployments->date}}
            </div>
        ...
        <div class="main">
            ...
            <p class="main-para">
                ...
                and unemployed residing with his/her family in {{ $certificate_unemployments->address }} of this barangay.

            </p>

            <p class="main-para">

                This certification is being issued upon the request of {{$certificate_unemployments->name}} for whatever legal purpose it may serve his/her best.

                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="purok_address" class="form-control"
                                placeholder="Enter purok address" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <!-- <textarea type="text" name="reason" class="form-control"
                                placeholder="Enter reason for application" required> -->
                                <textarea name="reason" class="form-control" placeholde="Enter reason for the application" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mx-auto">
                        <div class="form-group">
                            ...
                            <input type="text" name="punongbarangay" class="form-control"
                                placeholder="Enter Or number" required>
                        </div>
                    </div>
            ...
            <tbody class="text-center">
                ...
                <tr class="text-dark">
                    <td><button class="btn btn-sm btn-info">
                            <a href="{{ url('export_certificate_clearances/' . $item->id) }}"
                                class="btn btn-sm text-light">Print</a>
                        </button></td>
                    <td>{{ $item->name }}</td>
                    ...
                    <td class="d-flex align-item-center justify-between">
                        <span style="margin-left:2px;"> <a href="{{ url('edit_certificate_clearances/' . $item->id) }}"
                                class="btn btn-warning btn-sm text-light">Edit</a></span>
                        <span>
                            <a href="{{ url('delete_certificate_clearances/' . $item->id) }}"
